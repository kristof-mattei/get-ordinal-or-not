namespace GetOrdinalTests
{
    ...
    public class UnitTest1
    {
        ...
        private readonly string _query = new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("GetOrdinalTests.Query.sql")).ReadToEnd();
        ...
        private void InvokeQuery(Action<SqlDataReader> createObject)
        {
        ...
        {
            Action<SqlDataReader> foobar = sqlDataReader =>
                                           {
